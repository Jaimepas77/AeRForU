...
const { isAC, isTried, getUserID, getNick, getLastError, getProblemCategories, isProblemsCategory, getCategoryData, getCategoryProblems, getProblemLevel, getLevelsText, getUserProblemPosition } = require('./getters');
